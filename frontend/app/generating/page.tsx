...
=======
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar" style={{ background: 'linear-gradient(to bottom, rgb(0, 0, 0) 0%, rgb(30, 58, 138) 33%, rgb(59, 130, 246) 66%, rgb(255, 255, 255) 100%)' }}>
                  ...
                  {steps.map((step, index) => (
                    <div key={step.number} className="flex items-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className={`mt-3 text-sm font-medium text-center ${step.number <= currentStep ? 'text-white' : 'text-slate-300'
                          }`}>
                          {step.label}
                        </p>
                      </div>
