      ...
      <main className="pt-16 pb-20 px-6 sm:px-10 lg:px-16 xl:px-24">
        ...
        <section className="mb-16 md:mb-24 animate-in fade-in duration-1000">
          <div className="max-w-4xl mx-auto mb-12 text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-foreground mb-6 text-balance tracking-tighter">
        ...
        <section className="mb-16 md:mb-24 animate-in fade-in duration-1000 delay-200">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-foreground mb-4 tracking-tighter text-balance">
