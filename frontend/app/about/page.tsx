  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-16 pb-20 px-6 sm:px-10 lg:px-16 xl:px-24">
        {/* Hero Section */}
        <section className="mb-16 md:mb-20 animate-in fade-in duration-1000 text-center">
          <div className="max-w-3xl mb-12 mx-auto">
            <h1 className="text-4xl md:text-6xl font-black text-foreground mb-6 text-balance tracking-tighter">
        ...
        <section className="animate-in fade-in duration-1000 delay-300">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-foreground mb-4 tracking-tighter text-balance">
